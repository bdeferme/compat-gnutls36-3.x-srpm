...
Source0: https://www.gnupg.org/ftp/gcrypt/gnutls/v3.6/%{realname}-%{version}.tar.xz
Source1: https://www.gnupg.org/ftp/gcrypt/gnutls/v3.6/%{realname}-%{version}.tar.xz.sig
